...
CREATE TABLE `sys_menu` (
  ...
  `component_name` varchar(50) DEFAULT NULL COMMENT '组件名称，用于页面缓存使用',
...
CREATE TABLE `sys_user` (
  ...
  `theme` varchar(4000) DEFAULT NULL COMMENT '用户系统主题json',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '逻辑删除标志',
  `create_id` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '创建人id',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `avatar`, `gender`, `status`, `theme`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `login_ip`, `login_time`, `email`, `phone_number`) VALUES ('1', 'admin', '$2a$10$Z4TZ6xukbmrYLsvPC1R7SupnvyRhhRbPGtIuwK4rBx9EzQPA6pXEO', 'Yukino', '{\"url\":\"\",\"value\":\"Yukino\",\"type\":\"text\",\"backgroundColor\":\"rgb(19, 194, 194)\"}', '1', '0', '{\"layoutType\":\"header-content\",\"showViewTags\":true,\"dataDark\":false,\"colorPrimary\":\"rgb(250, 84, 28)\",\"siderTheme\":\"light\",\"groundGlass\":true,\"affixHead\":true,\"layoutBackgroundColor\":\"rgba(255,255,255,0.6)\",\"siderBackgroundColor\":\"rgba(20,20,20,0.6)\",\"siderMode\":\"horizontal\",\"siderWith\":200,\"originSiderWith\":200,\"routeTransition\":\"fade\",\"themeConfig\":{\"token\":{\"colorPrimary\":\"rgb(250, 84, 28)\"}}}', '0', NULL, NULL, '1', '2024-02-22 23:23:57', NULL, NULL, '12321311@qq.com', '15523647831');
COMMIT;
