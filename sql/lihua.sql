...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('031f293f02c84e4d9e27f866e18bc019', '1775035631645659138', '菜单管理', '菜单管理', 'page', '/menu', 'system/menu/index.vue', '0', '0', 'perim', 'BarsOutlined', 1, NULL, NULL, '1', '2024-04-07 20:12:50', '0', NULL, '0', '111', NULL, '0', 'new-page');
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('031f293f02c84e4d9e27f866e18bc059', '1775035631645659138', '字典管理', '字典管理', 'page', '/dict', 'system/dict/index.vue', '0', '0', 'perim', 'ReadOutlined', 1, NULL, NULL, '1', '2024-04-07 20:14:21', '0', NULL, '0', '22222', '{\"name\": \"John\"}', '0', 'new-page');
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1775035631645659138', '0', '系统管理', NULL, 'directory', '/system', NULL, '0', '0', 'perim', 'SettingOutlined', 1, '1', '2024-04-02 13:40:48', '1', '2024-04-05 18:22:41', '0', NULL, '1', NULL, NULL, '0', 'new-page');
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1775365169634258945', '0', '外部链接', NULL, 'directory', '/link', NULL, '0', '0', NULL, 'NodeIndexOutlined', 2, '1', '2024-04-03 11:30:16', '1', '2024-04-05 10:32:42', '0', NULL, '1', NULL, NULL, '0', 'new-page');
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1775365569678585857', '1775365169634258945', '系统内显示', NULL, 'link', '/inner', NULL, '0', '0', NULL, 'ChromeOutlined', 1, '1', '2024-04-03 11:31:51', '1', '2024-04-05 10:33:42', '0', NULL, '1', 'https://gitee.com/yukino_git/lihua', NULL, '0', 'inner');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1776947169823903746', '031f293f02c84e4d9e27f866e18bc019', '菜单保存', NULL, 'perms', '', NULL, '0', '0', 'system:menu:save1', NULL, 2, '1', '2024-04-07 20:16:34', NULL, NULL, '0', NULL, '0', NULL, NULL, '0', 'inner');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` (`id`, `name`, `code`, `status`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`) VALUES ('1', '管理员', 'ROLE_admin', '0', '0', NULL, NULL, NULL, NULL, NULL);
COMMIT;
