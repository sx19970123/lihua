...
CREATE TABLE `sys_attachment`  (
  ...
  `type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文件类型',
  ...
  `create_id` bigint NULL DEFAULT NULL COMMENT '上传人id',
  ...
  `client_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '客户端类型',
...
CREATE TABLE `sys_dept`  (
  ...
  `update_id` bigint NULL DEFAULT NULL COMMENT '最近一次更新人id',
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (1810226204790657025, 0, '狸花猫科技', 'lihua', 1, '0', '', '', '', NULL, '0', 1, '2024-07-08 16:15:34', 1, '2025-10-19 16:39:19', NULL);
...
CREATE TABLE `sys_dict_data`  (
  ...
  `parent_id` bigint NULL DEFAULT NULL COMMENT '父级字典id',
  ...
  `create_id` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_id` bigint NULL DEFAULT NULL COMMENT '最后一次更新人id',
...
INSERT INTO `sys_dict_data` VALUES (1840380919319064578, 0, 'sys_user_register_type', '管理员注册', '0', 1, NULL, '0', 1, '2024-09-29 21:19:38', 1, '2025-03-14 17:58:25', '0', 'processing');
...
INSERT INTO `sys_dict_data` VALUES (1995424806233780225, 0, 'sys_client_type', 'WEB', 'web', 1, NULL, '0', 1, '2025-12-01 17:28:42', NULL, NULL, '0', 'default');
INSERT INTO `sys_dict_data` VALUES (1995424807697592322, 0, 'sys_client_type', 'APP', 'app', 2, NULL, '0', 1, '2025-12-01 17:28:42', NULL, NULL, '0', 'processing');
INSERT INTO `sys_dict_data` VALUES (1995424809337565185, 0, 'sys_client_type', '微信小程序', 'wechat_mp', 3, NULL, '0', 1, '2025-12-01 17:28:42', NULL, NULL, '0', 'success');
...
INSERT INTO `sys_dict_type` VALUES (1995424677359595521, '客户端类型', 'sys_client_type', '0', '用于区分web｜app｜小程序', 1, '2025-12-01 17:28:11', NULL, NULL, '0', '0');
...
CREATE TABLE `sys_login_log`  (
  ...
  `create_id` bigint NULL DEFAULT NULL COMMENT '创建人id（操作人）',
  ...
  `client_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '客户端类型',
  `region` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'ip归属地',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1775035631645659138, '0', '系统管理', '系统管理', 'directory', '/system', NULL, '0', '0', 'directory', 'SettingOutlined', 2, 1, '2024-04-02 13:40:48', '1', '2025-11-06 22:04:58', '0', NULL, '1', NULL, NULL, '0', 'new-page');
INSERT INTO `sys_menu` VALUES (1776948212783730690, '1897209872981360641', '字典编辑', '字典编辑', 'perms', '', NULL, '0', '0', 'system:dict:modify', NULL, 1, 1, '2024-04-07 20:20:43', '1', '2024-10-04 20:45:15', '0', NULL, '0', NULL, NULL, '0', 'inner');
...
INSERT INTO `sys_menu` VALUES (1842179926320152578, '1897209379781541890', '菜单编辑', '菜单编辑', 'perms', NULL, NULL, '0', '0', 'system:menu:modify', NULL, 1, 1, '2024-10-04 20:28:15', NULL, NULL, '0', NULL, '0', NULL, NULL, '0', 'inner');
...
INSERT INTO `sys_menu` VALUES (1897209379781541890, '1775035631645659138', '菜单管理', '菜单管理', 'page', '/menu', '/system/menu/SystemMenu.vue', '0', '0', 'page', 'BarsOutlined', 3, NULL, NULL, '1', '2024-06-02 12:23:14', '0', NULL, '0', '111', NULL, '0', 'new-page');
INSERT INTO `sys_menu` VALUES (1897209872981360641, '1775035631645659138', '字典管理', '字典管理', 'page', '/dict', '/system/dict/SystemDict.vue', '0', '0', 'page', 'ReadOutlined', 6, NULL, NULL, '1', '2024-10-04 16:59:15', '0', NULL, '0', '22222', '', '0', 'new-page');
INSERT INTO `sys_menu` VALUES (1907043468160172033, '0', 'API文档', 'API文档', 'link', '/doc', NULL, '0', '0', 'link', 'FileTextOutlined', 6, 1, '2025-04-01 20:12:49', '1', '2025-04-05 10:36:37', '0', NULL, '0', 'http://localhost:8080/doc.html', NULL, '0', 'new-page');
INSERT INTO `sys_menu` VALUES (1909264238680707073, '1866101773239513090', '表格设置', '表格设置', 'page', '/table-setting', '/component/table-setting/TableSetting.vue', '0', '0', 'page', 'TableOutlined', 13, 1, '2025-04-07 23:17:22', '1', '2025-04-12 20:15:01', '0', NULL, '0', NULL, NULL, '0', 'inner');
...
CREATE TABLE `sys_notice`  (
  ...
  `release_id` bigint NULL DEFAULT NULL COMMENT '发布人id',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `icon` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '类型对应的图标',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of sys_post
-- ----------------------------
INSERT INTO `sys_post` VALUES (1842129333329264642, '1810226204790657025', 'lihua', '研发岗', 'lihua_dev', 1, '0', '', '', '', NULL, '0', 1, '2024-10-04 17:07:13', 1, '2025-04-09 18:45:27', NULL);
INSERT INTO `sys_post` VALUES (1842129449343713282, '1810226204790657025', 'lihua', '销售岗', 'lihua_sell', 2, '1', NULL, NULL, NULL, NULL, '0', 1, '2024-10-04 17:07:40', 1, '2025-04-24 21:46:04', NULL);
INSERT INTO `sys_post` VALUES (1842188089392041986, '1810226204790657025', 'lihua', '测试岗', 'lihua_test', 3, '1', NULL, NULL, NULL, NULL, '1', 1, '2024-10-04 21:00:41', 1, '2025-04-24 21:46:05', NULL);
...
INSERT INTO `sys_role` VALUES (1842149851067514881, '访客用户', 'ROLE_visitor', '0', '0', 1, '2024-10-04 18:28:45', 1, '2025-10-13 21:38:49', '');
INSERT INTO `sys_role` VALUES (1861768418410799106, '角色测试', 'ROLE_TEST', '0', '0', 1, '2024-11-27 21:45:56', 1, '2025-03-05 16:59:01', NULL);
...
INSERT INTO `sys_role_menu` VALUES (1842149851067514881, 1907043468160172033);
INSERT INTO `sys_role_menu` VALUES (1842149851067514881, 1909264238680707073);
...
CREATE TABLE `sys_setting`  (
  `id` bigint NOT NULL COMMENT '主键',
  `setting_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '设置key',
  `json` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '设置参数',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `create_id` bigint NULL DEFAULT NULL COMMENT '创建人',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `update_id` bigint NULL DEFAULT NULL COMMENT '更新id',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '删除标识',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户和登录后设置关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_user_dept`  (
  ...
  `create_id` bigint NULL DEFAULT NULL COMMENT '绑定人id',
...
-- ----------------------------
INSERT INTO `sys_user_dept` VALUES (1, 1810226204790657025, '2025-10-19 16:38:32', 1, '0');
...
-- ----------------------------
INSERT INTO `sys_view_tab` VALUES (1, 1777536311941824513, '0', '0');
INSERT INTO `sys_view_tab` VALUES (1, 1838487275271753729, '0', '1');
INSERT INTO `sys_view_tab` VALUES (1, 1897209379781541890, '0', '1');
