...
INSERT INTO `sys_dept` (`id`, `parent_id`, `name`, `code`, `sort`, `status`, `manager`, `phone_number`, `email`, `fax`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`) VALUES ('1794305772230627329', '0', '魅族科技', 'meizu', 2, '0', NULL, '', NULL, NULL, '0', '1', '2024-05-25 17:53:27', '1', '2024-06-01 19:16:14', NULL);
...
INSERT INTO `sys_dict_data` (`id`, `parent_id`, `dict_type_code`, `label`, `value`, `sort`, `remark`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `status`, `tag_style`) VALUES ('1794263238364188674', '0', 'user_gender', '未知', '2', 3, NULL, '0', '1', '2024-05-25 15:04:26', '1', '2024-05-25 15:37:34', '0', 'default');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dict_type` (`id`, `name`, `code`, `type`, `remark`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `status`) VALUES ('1771163166122561537', '系统状态', 'sys_status', '0', '系统通用状态标识', '1', '2024-03-22 21:13:00', '1', '2024-04-13 17:26:17', '0', '0');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1777539832263114753', '0', '通知公告', '通知公告', 'page', '/notice', '/Notice.vue', '0', '0', 'page', 'MessageOutlined', 1, '1', '2024-04-09 11:31:36', '1', '2024-04-19 21:59:03', '0', NULL, '0', NULL, NULL, '0', 'inner');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` (`id`, `name`, `code`, `status`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`) VALUES ('1', '超级管理员', 'ROLE_admin', '0', '0', NULL, '2024-05-16 21:32:55', '1', '2024-05-29 20:38:07', NULL);
INSERT INTO `sys_role` (`id`, `name`, `code`, `status`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`) VALUES ('1779067819464077314', ' 一般角色', 'ROLE_common', '1', '0', '1', '2024-04-13 16:43:16', '1', '2024-06-01 17:55:53', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `avatar`, `gender`, `status`, `theme`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `email`, `phone_number`, `remark`) VALUES ('1', 'admin', '$2a$10$Z4TZ6xukbmrYLsvPC1R7SupnvyRhhRbPGtIuwK4rBx9EzQPA6pXEO', 'Yukino', '{\"url\":\"\",\"value\":\"Yukino\",\"type\":\"text\",\"backgroundColor\":\"rgb(245, 34, 45)\"}', '1', '0', '{\"layoutType\":\"header-sider\",\"showViewTabs\":true,\"dataTheme\":false,\"colorPrimary\":\"rgb(114, 46, 209)\",\"siderTheme\":\"light\",\"groundGlass\":true,\"affixHead\":true,\"layoutBackgroundColor\":\"rgba(255,255,255,0.6)\",\"siderBackgroundColor\":\"rgba(255,255,255,1)\",\"siderMode\":\"inline\",\"siderWith\":200,\"originSiderWith\":200,\"routeTransition\":\"breathe\",\"themeConfig\":{\"token\":{\"colorPrimary\":\"rgb(114, 46, 209)\"}}}', '0', NULL, '2024-06-02 16:57:25', '1', '2024-06-01 18:11:27', '2651518588@qq.com', '15510916240', NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_dept` (`user_id`, `dept_id`, `create_time`, `create_id`, `default_dept`) VALUES ('1', '1', '2024-06-02 16:57:25', '1', '0');
INSERT INTO `sys_user_dept` (`user_id`, `dept_id`, `create_time`, `create_id`, `default_dept`) VALUES ('1', '1794305772230627329', '2024-06-02 16:57:25', '1', '1');
INSERT INTO `sys_user_dept` (`user_id`, `dept_id`, `create_time`, `create_id`, `default_dept`) VALUES ('1', '2', '2024-06-02 16:57:25', '1', '1');
COMMIT;
