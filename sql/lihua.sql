...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('031f293f02c84e4d9e27f866e18bc019', '1775035631645659138', '菜单管理', '菜单管理', 'page', '/menu', 'system/menu/index.vue', 'index', '0', '0', 'perim', 'StepBackwardOutlined', 1, NULL, NULL, '1', '2024-04-02 13:41:10', '0', NULL, '1', NULL, NULL, '0', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('031f293f02c84e4d9e27f866e18bc059', '1775035631645659138', '字典管理', '字典管理', 'page', '/dict', 'system/dict/index.vue', 'index', '0', '0', 'perim', 'StepBackwardOutlined', 1, NULL, NULL, '1', '2024-04-02 13:41:16', '0', NULL, '1', NULL, NULL, '0', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1775032652699963394', '0', '测试', NULL, 'directory', '/test', NULL, 'test', '0', '0', 'perim', 'AlipayCircleOutlined', 10, '1', '2024-04-02 13:28:58', NULL, NULL, '1', NULL, '1', NULL, NULL, '0', 'inner');
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1775032925380055042', '1775032652699963394', '测试页面', NULL, 'page', '/t', 'system/test/index.vue', 'index', '0', '0', 'perim', 'AntCloudOutlined', 10, '1', '2024-04-02 13:30:03', '1', '2024-04-02 13:38:00', '1', NULL, '1', NULL, NULL, '0', 'inner');
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES ('1775035631645659138', '0', '系统管理', NULL, 'directory', '/system', NULL, 'system', '0', '0', 'perim', 'SettingOutlined', 1, '1', '2024-04-02 13:40:48', NULL, NULL, '0', NULL, '1', NULL, NULL, '0', 'inner');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `avatar`, `gender`, `status`, `theme`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `login_ip`, `login_time`, `email`, `phone_number`) VALUES ('1', 'admin', '$2a$10$Z4TZ6xukbmrYLsvPC1R7SupnvyRhhRbPGtIuwK4rBx9EzQPA6pXEO', 'Yukino', '{\"url\":\"\",\"value\":\"Unfold\",\"type\":\"icon\",\"backgroundColor\":\"rgb(250, 173, 20)\"}', '1', '0', '{\"layoutType\":\"header-sider\",\"showViewTabs\":true,\"dataDark\":false,\"colorPrimary\":\"rgb(114, 46, 209)\",\"siderTheme\":\"light\",\"groundGlass\":true,\"affixHead\":true,\"layoutBackgroundColor\":\"rgba(255,255,255,0.6)\",\"siderBackgroundColor\":\"rgba(255,255,255,1)\",\"siderMode\":\"inline\",\"siderWith\":220,\"originSiderWith\":220,\"routeTransition\":\"breathe\",\"themeConfig\":{\"token\":{\"colorPrimary\":\"rgb(114, 46, 209)\"}}}', '0', NULL, NULL, '1', '2024-04-02 21:26:38', NULL, NULL, '12321311@qq.com', '15523647831');
COMMIT;
