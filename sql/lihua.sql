...
INSERT INTO `sys_dict_data` (`id`, `parent_id`, `dict_type_code`, `label`, `value`, `sort`, `remark`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `status`, `tag_style`) VALUES ('1773701160050212865', '0', 'sys_menu_type', '页面', 'page', 2, NULL, '0', '1', '2024-03-29 21:18:05', NULL, NULL, '0', 'default');
...
INSERT INTO `sys_dict_data` (`id`, `parent_id`, `dict_type_code`, `label`, `value`, `sort`, `remark`, `del_flag`, `create_id`, `create_time`, `update_id`, `update_time`, `status`, `tag_style`) VALUES ('1774046926568538113', '0', 'sys_menu_type', '链接', 'link', 3, NULL, '0', '1', '2024-03-30 20:12:02', '1', '2024-03-30 20:12:07', '0', 'default');
...
INSERT INTO `sys_dict_type` (`id`, `name`, `code`, `type`, `remark`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `status`) VALUES ('1773700957867982850', '菜单类型', 'sys_menu_type', '0', '系统菜单配置类型，分为 目录、页面、链接、权限', '1', '2024-03-29 21:17:17', '1', '2024-03-31 09:41:10', '0', '0');
...
CREATE TABLE `sys_menu` (
  ...
  `link_open_type` char(10) DEFAULT NULL COMMENT '链接打开方式',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('031f293f02c84e4d9e27f866e18bc019', '0', '菜单管理', '菜单管理', 'page', '/menu', 'system/menu/index.vue', 'index', '/menu', NULL, '0', 'admin', 'StepBackwardOutlined', 1, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '0', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('031f293f02c84e4d9e27f866e18bc059', '0', '字典管理', '字典管理', 'page', '/dict', 'system/dict/index.vue', 'index', '/dict', NULL, '0', 'admin', 'StepBackwardOutlined', 1, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '0', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('05919353547b4f0887a9318ee73b832f', '19dd01c0806e4a0981d76d62f78d5552', '监控页', '监控页', 'menu', 'jky', '/system/menu/index.vue', 'index', '/ybp/jky', NULL, '0', 'admin', 'StepBackwardOutlined', 6, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('0fe0edb2374e4e99a4d3266fe1406557', '6dba376cc8a543109c30f484c240fd30', '基础表单', '基础表单', 'page', 'jcbd', 'jcbd/index.vue', 'index', '/bdy/jcbd', NULL, '0', 'admin', 'StepBackwardOutlined', 9, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('19dd01c0806e4a0981d76d62f78d5552', '0', '仪表盘', '仪表盘', 'menu', '/ybp', NULL, NULL, '/ybp', NULL, '0', 'admin', 'StepBackwardOutlined', 1, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('458c960671c34ef5a143d200b4f171ce', '0', '没子集的空目录', '没子集的空目录', 'menu', 'kml', NULL, NULL, '/kml', NULL, '0', 'admin', 'StepBackwardOutlined', 1, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('6dba376cc8a543109c30f484c240fd30', '0', '表单页', '表单页', 'menu', '/bdy', NULL, NULL, '/bdy', NULL, '0', 'admin', 'StepBackwardOutlined', 2, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('7b22134b42304cec8bb4c825ba75be47', '0', '列表页', '列表页', 'menu', '/lby', NULL, NULL, '/lby', NULL, '0', 'admin', 'StepBackwardOutlined', 3, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('80981da36e814adaa5c3c1648c4c1f62', 'dd8a7f5c42c74d3c86b6821c279654eb', '列表', '列表', 'menu', 'lb', NULL, NULL, '/lby/bzlb/lb', NULL, '0', 'admin', 'StepBackwardOutlined', 16, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('89428c4bd1d04e4bb149b10a2e576423', '7b22134b42304cec8bb4c825ba75be47', '卡片列表', '卡片列表', 'page', 'kplb', 'kplb/index.vue', 'index', '/lby/kplb', NULL, '0', 'admin', 'StepBackwardOutlined', 12, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('a702173a0cab492987d978497d689df5', '19dd01c0806e4a0981d76d62f78d5552', '欢迎页', '欢迎页', 'page', 'hyy', 'hyy/index.vue', 'index', '/ybp/hyy', NULL, '0', 'admin', 'StepBackwardOutlined', 7, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('bd71c2f6cc994ce89f665576daf7db77', '19dd01c0806e4a0981d76d62f78d5552', '分析页', '分析页', 'page', 'fxy', 'fxy/index.vue', 'index', '/ybp/fxy', NULL, '0', 'admin', 'StepBackwardOutlined', 8, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('c87da65bcaff4a418098ec647434eb08', '7b22134b42304cec8bb4c825ba75be47', '查询列表', '查询列表', 'page', 'cxlb', 'cxlb/index.vue', 'index', '/lby/cxlb', NULL, '0', 'admin', 'StepBackwardOutlined', 13, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('cc111dfbdfb2442aad2a397a89fbbbeb', '80981da36e814adaa5c3c1648c4c1f62', '表', '表', 'page', 'b', 'b/index.vue', 'index', '/lby/bzlb/lb/b', NULL, '0', 'admin', 'StepBackwardOutlined', 15, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('cfc9411130704e9ea1ae6ce3a5ef8581', '6dba376cc8a543109c30f484c240fd30', '高级表单', '高级表单', 'page', 'gjbd', 'gjbd/index.vue', 'index', '/bdy/gjbd', NULL, '0', 'admin', 'StepBackwardOutlined', 10, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('dd8a7f5c42c74d3c86b6821c279654eb', '7b22134b42304cec8bb4c825ba75be47', '标准列表', '标准列表', 'menu', 'bzlb', NULL, NULL, '/lby/bzlb', NULL, '0', 'admin', 'StepBackwardOutlined', 14, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('ea37b1ef262e4f86aa1dc5bbd43e62c4', '0', '工作台', '工作台', 'page', 'gzt', 'gzt/index.vue', 'index', '/gzt', NULL, '0', 'admin', 'StepBackwardOutlined', 4, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `component_name`, `router_path_key`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `no_cache`, `link_path`, `query`, `skip`, `link_open_type`) VALUES ('eb8819f1cdca4d11bb2910a806f85d81', '05919353547b4f0887a9318ee73b832f', '控', '控', 'page', 'k', 'k/index.vue', 'index', '/ybp/jky/k', NULL, '0', 'admin', 'StepBackwardOutlined', 5, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, '1', '1', NULL);
COMMIT;
...
INSERT INTO `sys_star_view` (`user_id`, `router_path_key`, `affix`, `star`) VALUES ('1', '/dict', '0', '1');
...
INSERT INTO `sys_star_view` (`user_id`, `router_path_key`, `affix`, `star`) VALUES ('1', '/menu', '0', '0');
