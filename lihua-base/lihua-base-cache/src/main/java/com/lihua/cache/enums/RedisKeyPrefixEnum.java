...
public enum RedisKeyPrefixEnum {
    ...
    RATE_LIMIT_REDIS_PREFIX("RATE_LIMIT:", "接口限流", null),

    LOGIN_FAIL_COUNT_REDIS_PREFIX("LOGIN_FAIL_COUNT:", "登录失败计数", null),

    LOGIN_LOCK_REDIS_PREFIX("LOGIN_LOCK:", "登录锁定", null),

    PERMISSION_UPDATE_REDIS_PREFIX("REDIS_CACHE_PERMISSION_UPDATE:", "权限数据更新标记", null),
